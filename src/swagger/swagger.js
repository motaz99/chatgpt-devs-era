...
const options = {
  definition: {
    ...
    paths: {
      ...
      '/orders/': orderSwagger.postOrder,
      '/orders/cancel-order/:id': orderSwagger.clientCancelOrder,
      '/orders/chef-orders': orderSwagger.getChefOrders,
      '/orders/chef-update-order-status': orderSwagger.chefUpdateStatus,
    },
  },
